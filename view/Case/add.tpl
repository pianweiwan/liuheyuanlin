...
<div class="m-right">
    ...
    <div class="main" style="margin-left:6px">
        ...
        <div>
            <h2><input class="title" name="title" placeholder="标题"></h2>
            <h2><input class="cover" type="file" name="cover" placeholder="封面上传"></h2>
        ...
        <input type="hidden" name="content" id="designContent">
        <button class="publish btn btn-default">发布新闻</button>
    </div>
    </form>
</div>
...
//            $.get('/design/upload', {title:title,content:content}, function(jdata) {
//                if(jdata['code'] != 200) {
